      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <button className="bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 px-6 py-2 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">
              Get Started
            </button>
          </div>
        ...
        <div className={`lg:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="py-4 space-y-2 bg-white/95 backdrop-blur-md rounded-xl mt-2 border border-gray-200/20">
            ...
            <div className="px-4 py-3 border-t border-gray-200/50 space-y-3">
              ...
              <button className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 py-3 rounded-lg font-semibold">
                Get Quote
              </button>
            </div>
          </div>
