      ...
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed">
            Join thousands of satisfied clients who have accelerated their growth with our digital services.
          </p>
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            <button className="bg-white text-purple-600 px-12 py-5 rounded-full font-extrabold text-lg shadow-2xl hover:shadow-3xl">
              Get Started Today
            </button>
            <button className="border-3 border-white text-white px-12 py-5 rounded-full font-extrabold text-lg hover:bg-white/20">
              Schedule a Demo
            </button>
          </div>
        </div>
